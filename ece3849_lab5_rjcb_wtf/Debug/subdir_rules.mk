...
%.obj: ../%.c $(GEN_OPTS) | $(GEN_FILES) $(GEN_MISC_FILES)
	...
	"C:/ti/ccs1200/ccs/tools/compiler/ti-cgt-arm_20.2.6.LTS/bin/armcl" -mv7M4 --code_state=16 --float_support=FPv4SPD16 -me -O1 --opt_for_speed=2 --include_path="C:/Users/rjcroesball/Documents/3849reprj/ece3849_lab4_rjcroesball_wtfolan_4_18_FINITO.zip_expanded/ece3849_lab4_rjcb_wtf" --include_path="C:/Users/rjcroesball/Documents/3849reprj/ece3849_lab4_rjcroesball_wtfolan_4_18_FINITO.zip_expanded/ece3849_lab4_rjcb_wtf" --include_path="C:/ti/tirtos_tivac_2_16_01_14/products/TivaWare_C_Series-2.1.1.71b" --include_path="C:/ti/ccs1200/ccs/tools/compiler/ti-cgt-arm_20.2.6.LTS/include" --define=ccs="ccs" --define=PART_TM4C1294NCPDT --define=ccs --define=TIVAWARE -g --gcc --diag_warning=225 --diag_warning=255 --diag_wrap=off --display_error_number --gen_func_subsections=on --abi=eabi --preproc_with_compile --preproc_dependency="$(basename $(<F)).d_raw" $(GEN_OPTS__FLAG) "$<"
	@echo 'Finished building: "$<"'
	@echo ' '

build-304277441:
	@$(MAKE) --no-print-directory -Onone -f subdir_rules.mk build-304277441-inproc

build-304277441-inproc: ../rtos.cfg
	@echo 'Building file: "$<"'
...
configPkg/linker.cmd: build-304277441 ../rtos.cfg
configPkg/compiler.opt: build-304277441
configPkg/: build-304277441
