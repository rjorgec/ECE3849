...
//    //all the ADC1 stuff //moved to sampling.c (why didnt you tell me to make that before I wrote this
//    SysCtlPeripheralEnable(SYSCTL_PERIPH_GPIOE);
//    GPIOPinTypeADC(GPIO_PORTE_BASE, GPIO_PIN_0); // GPIO setup for analog input AIN3
//    // initialize ADC peripherals
////    SysCtlPeripheralEnable(SYSCTL_PERIPH_ADC0); //do i need this? adc0 is already initialized
//    SysCtlPeripheralEnable(SYSCTL_PERIPH_ADC1);
//    // ADC clock
////    uint32_t pll_frequency = SysCtlFrequencyGet(CRYSTAL_FREQUENCY); //dont need this
////    uint32_t pll_divisor = (pll_frequency - 1) / (16 * ADC_SAMPLING_RATE) + 1; // round up //dont need this?
////    ADCClockConfigSet(ADC0_BASE, ADC_CLOCK_SRC_PLL | ADC_CLOCK_RATE_FULL, pll_divisor); //dont think i need this either
//    ADCClockConfigSet(ADC1_BASE, ADC_CLOCK_SRC_PLL | ADC_CLOCK_RATE_FULL, pll_divisor);
//    // choose ADC1 sequence 0; disable before configuring
//    ADCSequenceDisable(ADC1_BASE, 0);
//    ADCSequenceConfigure(ADC1_BASE, 0, ADC_TRIGGER_PROCESSOR, 0); // specify the "Always" trigger
//    // in the 0th step, sample channel 3 (AIN3)
//    // enable interrupt, and make it the end of sequence
//    ADCSequenceStepConfigure(ADC1_BASE, 0, 0, ADC_CTL_CH3); //Not sure if CH3 is correct, IF SOMETHING DOESNT WORK LOOK HERE
//    // enable the sequence. it is now sampling
//    ADCSequenceEnable(ADC1_BASE, 0);
//    // enable sequence 0 interrupt in the ADC1 peripheral
//    ADCIntEnable(ADC1_BASE, 0);
//    IntPrioritySet(ADC1_BASE, 0); // set ADC1 sequence 0 interrupt priority
...
////(i know this shouldnt be here, i might move it later)
